...
# OBS: Referência -> O detalhamento do código e a justificativa de como e por que as melhorias foram adotadas no modelo "XGboost" está documentado na secção "11. Deploy", em "11.1 Refinamento Realizados" na pasta "docs" em "documentacao.md"
...
def prepare1_fasttext_vectors(vec_path):
...
def prepare2_fasttext_vectors(sentence, embeddings):
    """
...
def predict_xgboost(text, embeddings, model_neg_vs_rest, model_pos_vs_neutral):
    """
    ...
    # Vetorizar o texto
    vectorized_text = prepare2_fasttext_vectors(preprocessed_text, embeddings)
